...
_LAZY_EXPORTS = {
    ...
    "LDScoreSource": (".ldscore_source", "LDScoreSource"),
    ...
    "PreparedRegressionInputs": (".regression_runner", "PreparedRegressionInputs"),
    "PartitionedH2BatchResult": (".regression_runner", "PartitionedH2BatchResult"),
